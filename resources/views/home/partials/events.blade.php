...
<section id="events" class="scroll-mt-24 hub-section">
    <div class="flex flex-wrap items-end justify-between gap-6 mb-12">
        ...
        <a href="{{ route('events.index') }}" class="shrink-0 text-sm font-bold text-hub-purple-light hover:text-white transition-colors">@site('events.view_all')</a>
    </div>
    ...
    @if(!$featuredEvent)
        <div class="relative overflow-hidden rounded-2xl border border-white/10 hub-blueprint-grid px-8 py-20 md:px-16 md:py-28 text-center">
            ...
            <div class="relative flex flex-col items-center gap-5">
                <p class="font-display text-2xl md:text-4xl font-bold max-w-2xl">@site('events.empty_heading')</p>
                <p class="text-gray-400 max-w-lg">@site('events.empty_body')</p>
