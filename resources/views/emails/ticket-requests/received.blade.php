{{-- resources/views/emails/ticket-requests/received.blade.php --}}
@extends('emails.layout')

@section('preview', __('We received your ticket request.'))
...
@section('content')
    ...
    <p style="margin:0 0 24px;font-size:15px;line-height:1.8;color:#4a4a4a;">
        {{ __('Thank you for requesting a ticket to :event. Our team will review your request and email you as soon as a decision is made.', ['event' => $eventName]) }}
    </p>
